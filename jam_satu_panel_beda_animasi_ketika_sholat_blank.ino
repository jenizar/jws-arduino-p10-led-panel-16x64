...
#include <angka6x13.h>
#include <SPI.h>
//char weekDay[][9] = {"SENIN, " , "SELASA, ", "RABU, ", "KAMIS, ", "JUM'AT, ", "SABTU, ", "AHAD, ", "SENIN, " ,  }; // array hari, dihitung mulai dari senin, hari senin angka nya =0,
char weekDay[][9] = {"AHAD, ", "SENIN, " , "SELASA, ", "RABU, ", "KAMIS, ", "JUM'AT, ", "SABTU, ", "AHAD, ",   }; // array hari, dihitung mulai dari senin, hari senin angka nya =0,
...
void mulai()
{
  ...
  if (now.second() > 1) {
...

    {
      ...
      int lamanya;
      for (lamanya = 0; lamanya < 6700; lamanya++) {
        lamanya = lamanya + 1;
        delay(1000);
...
//      double bujur = 110.4;   //Longitude
      ...
      double lintang = -6.2088;  // Latitude - Jakarta, Indonesia
      double bujur = 106.8456;   // Longitude - Jakarta, Indonesia     
